...
Simply [click here to view the live interactive website](https://Kehnney.github.io/Data_Science_Portfolio-WIP.github.io/) directly in your browser. Thanks to Quarto and Shinylive, all Python machine learning models and visualizations compile into WebAssembly and execute entirely on the client-side.
